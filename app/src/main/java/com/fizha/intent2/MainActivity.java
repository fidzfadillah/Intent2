    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_move_with_data_activity:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Muhammad Hafidz Fadillah");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 17);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_move_activity_object:
                Person mPerson = new Person();
                mPerson.setName("Muhammad Hafidz Fadillah");
                mPerson.setAge(17);
                mPerson.setEmail("fishfadillah14@gmail.com");
            ...
            case R.id.btn_dial_number:
                String phoneNumber= "085720019793";
